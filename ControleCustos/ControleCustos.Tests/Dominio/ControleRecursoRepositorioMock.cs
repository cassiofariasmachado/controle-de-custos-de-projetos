    ...
    public class ControleRecursoRepositorioMock : IControleRecursoRepositorio
    {
        ...
        public ControleRecursoRepositorioMock()
        {
            ...
            this.listaControleRecursos.Add(new ControleRecurso(1,
                projeto,
                new Patrimonio(1, "Notebook", TipoRecurso.Fisico, 100M, SituacaoRecurso.Disponivel, true, "Inspiron", "Dell", DateTime.Now, 1000M, 10),
            ...
            this.listaControleRecursos.Add(new ControleRecurso(3,
                projeto2,
                new Compartilhado(1, "VM Interna", TipoRecurso.Fisico, 1000M, SituacaoRecurso.Disponivel, true, "10.10.1.1", true, 1000.00M, 1000, 100, true, true),
